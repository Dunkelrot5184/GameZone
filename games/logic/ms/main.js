/*----- constants -----*/
var bombImage = '<img src="../img/ms/bomb.png">';
var flagImage = '<img src="../img/ms/flag.png">';
var wrongBombImage = '<img src="../img/ms/wrong-bomb.png">'
var sizeLookup = {
  '9': {totalBombs: 10, tableWidth: '245px'},
  '16': {totalBombs: 40, tableWidth: '420px'},
  '30': {totalBombs: 200, tableWidth: '794px'},
  "50": {totalBombs: 2499, tableWidth: '1490px'}
};
var colors = [
  '',
  '#0000FA',
...
function buildTable() {
  ...
  <tr>
    <td class="menu" id="window-title-bar" colspan="${size}">
      <div id="window-title"><img src="../img/ms/mine-menu-icon.png"> Minesweeper</div>
      <div id="window-controls"><img src="../img/ms/window-controls.png"></div>
    </td>
  </tr>
    <tr>
      <td class="menu" colspan="${size}">
          <section id="status-bar">
            ...
            <div id="reset"><img src="../img/ms/smiley-face.png"></div>
...
function render() {
  ...
  if (hitBomb) {
    document.getElementById('reset').innerHTML = '<img src=../img/ms/dead-face.png>';
    runCodeForAllCells(function(cell) {
    ...
    document.getElementById('reset').innerHTML = '<img src=../img/ms/cool-face.png>';
    clearInterval(timerId);
  }
};
